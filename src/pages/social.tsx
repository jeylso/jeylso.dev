...
export default function SocialPage() {
  return (
    <div className="grid grid-cols-2  grid-flow-row auto-rows-max gap-4 no-select">
      <Link href="/">
        <a className="col-start-1 row-start-1 text-4xl">
          &#171; <span className="text-2xl -ml-2">Home</span>
        </a>
      </Link>
      <div className="col-span-2 row-start-2 text-center mb-5">
        <h1 className="text-5xl font-light tracking-wider">Social Media</h1>
      </div>
      <a
        href="https://facebook.com/jeylso"
        target="_blank"
        rel="noopener noreferrer"
        className="row-start-3 outline-none"
      >
        <div className="flex shadow-lg rounded-full bg-gray-300">
          <div className="bg-facebook rounded-full py-2 px-3 w-1/2">
            <svg
		...
		h2.516V4.458z"
          ...
          <div className="py-2 px-1 w-32">
            <p className="text-center -mt-1.3 mr-4 font-medium">@jeylso</p>
          </div>
        </div>
      </a>
      <a
        href="https://twitter.com/jeylso"
        target="_blank"
        rel="noopener noreferrer"
        className="col-start-2 row-start-3 outline-none"
      >
        <div className="flex shadow-lg rounded-full bg-gray-300">
          <div className="bg-twitter rounded-full py-2 px-3 w-1/2">
            <svg
              className="fill-current text-white w-5 h-full block m-auto"
	...
	C507.7,94.204,503.76,93.294,500.398,94.784z"
      ...
      <a
        href="https://github.com/jeylso"
        target="_blank"
        rel="noopener noreferrer"
        className="col-span-2 row-start-4 flex items-center justify-center outline-none"
      >
        <div className="flex shadow-lg rounded-full bg-gray-300 w-40">
          <div className="bg-black rounded-full py-2 px-3 w-1/2">
            <svg
              className="fill-current text-white w-5 h-full block m-auto"
